...
# options passed: -m32 -masm=intel -mtune=generic -march=i686 -O0 -fstack-protector-strong -fasynchronous-unwind-tables -fstack-protector-strong -fstack-clash-protection
	.text
	.globl	foo
	.type	foo, @function
foo:
